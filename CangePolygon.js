...
document
    .querySelector('#selectcolor_Polygon')
...
function CangePolygon() {
    ...
    const sliderValueO = document.getElementById(
        'slider_Polygon_opacity_value',
    );
    document.getElementById('slider_Polygon_opacity').value =
