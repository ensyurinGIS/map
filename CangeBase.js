...
slider_base_brightnessmin.addEventListener('input', (e) => {
    const sliderValue = document.getElementById(
        'slider_base_brightnessmin_value',
    );
    map.setPaintProperty(
        property_base.value,
...
slider_base_brightnessmax.addEventListener('input', (e) => {
    const sliderValue = document.getElementById(
        'slider_base_brightnessmax_value',
    );
    map.setPaintProperty(
        property_base.value,
...
function CangeBase() {
    ...
    const nowopacity =
        map.getPaintProperty(layer.value, 'raster-opacity') * 100;
    document.getElementById('slider_base_opacity').value =
    ...
    const sliderValueS = document.getElementById(
        'slider_base_saturation_value',
    );
    document.getElementById('slider_base_saturation').value =
    ...
    document.getElementById('slider_base_contrast').value =
    ...
    document.getElementById('slider_base_brightnessmin').value =
        Math.trunc(nowbmin);
    ...
    document.getElementById('slider_base_brightnessmax').value =
        Math.trunc(nowbmix);
